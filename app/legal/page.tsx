...
export default function LegalPage() {
  ...
  return (
    // <> dan <main> dihapus. Navbar dan Footer juga dihapus.
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-24">
            <Card className="bg-white/80 dark:bg-[#1b263b]/80">
              <CardHeader>
        ...
        <div className="lg:col-span-3 space-y-8">
          {/* Privacy Policy */}
          <Card id="privacy-policy" className="bg-white/80 dark:bg-[#1b263b]/80">
            <CardHeader>
          ...
          {/* Terms of Service */}
          <Card id="terms-of-service" className="bg-white/80 dark:bg-[#1b263b]/80">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-foreground flex items-center">
